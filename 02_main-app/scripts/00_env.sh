...
source "${SCRIPT_DIR}/env/deploy.env.sh"
...
export APP_SECRET_MAPPING MIGRATION_SECRET_MAPPING APP_SERVICE_ACCOUNT_NAME \
  MIGRATION_SERVICE_ACCOUNT_NAME DEPLOY_SERVICE_ACCOUNT_NAME
