...
ROLE_PERMISSIONS="cloudbuild.builds.create,cloudbuild.builds.get,cloudbuild.builds.list,cloudbuild.builds.update,cloudbuild.connections.create,cloudbuild.connections.get,cloudbuild.repositories.create,cloudbuild.repositories.get,cloudbuild.triggers.create,cloudbuild.triggers.get,cloudbuild.triggers.list,cloudbuild.triggers.update,artifactregistry.dockerimages.get,artifactregistry.dockerimages.list,artifactregistry.repositories.create,artifactregistry.repositories.get,artifactregistry.repositories.list,cloudsql.instances.create,cloudsql.instances.get,cloudsql.instances.list,cloudsql.instances.update,cloudsql.databases.create,cloudsql.databases.get,cloudsql.databases.list,cloudsql.users.create,cloudsql.users.get,cloudsql.users.list,cloudsql.users.update,compute.addresses.create,compute.addresses.get,compute.addresses.list,compute.addresses.use,compute.routers.create,compute.routers.get,compute.routers.list,compute.routers.update,compute.routers.nats.create,compute.routers.nats.get,compute.routers.nats.update,iam.roles.create,iam.serviceAccounts.create,iam.serviceAccounts.get,iam.serviceAccounts.getIamPolicy,iam.serviceAccounts.setIamPolicy,secretmanager.secrets.create,secretmanager.secrets.get,secretmanager.secrets.list,secretmanager.secrets.getIamPolicy,secretmanager.secrets.setIamPolicy,secretmanager.versions.add,run.services.get,run.services.list,run.services.update,run.jobs.get,run.jobs.list,run.jobs.update,resourcemanager.projects.get,resourcemanager.projects.getIamPolicy,resourcemanager.projects.setIamPolicy,serviceusage.services.enable,serviceusage.services.list"
