...
if gcloud builds triggers describe "$TRIGGER_NAME" \
  ...
  # 唯讀查詢既有 release trigger 的 repository，不修改資源。
  ...
  # 唯讀查詢既有 release trigger 的 tag pattern，不修改資源。
  ...
  # 唯讀查詢既有 release trigger 的 build config，不修改資源。
  ...
  # 唯讀查詢既有 release trigger 的 service account，不修改資源。
  ...
  # 唯讀查詢既有 release trigger 的區域，不修改資源。
  ...
  # 唯讀查詢既有 release trigger 的 repository substitution，不修改資源。
  ...
  # 唯讀查詢既有 release trigger 的 app image substitution，不修改資源。
  ...
  # 唯讀查詢既有 release trigger 的 migration image substitution，不修改資源。
