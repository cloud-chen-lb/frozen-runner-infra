...
bash 02_main-app/scripts/02_setup-deploy-iam.sh
bash 02_main-app/scripts/13_create-production-trigger.sh
bash 02_main-app/scripts/14_run-production-deploy.sh v<release>
bash 02_main-app/scripts/15_verify-deployment.sh v<release>
```

`14_run-production-deploy.sh` 接受 `v` 開頭的 release tag，並可用環境變數或
