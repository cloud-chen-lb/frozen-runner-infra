...
bash 02_main-app/scripts/12_setup-service-accounts.sh
bash 02_main-app/scripts/16_setup-secrets.sh
```

`16_setup-secrets.sh` 只建立 Secret Manager secret metadata 與 scoped
